-- mfussenegger/nvim-dap (+ dap-ui, dap-go, virtual text, mason-nvim-dap)
local dap = require("dap")
local ui = require("dapui")

-- `require('mason').setup()` lives in custom/plugins/mason.lua, which is loaded
-- first, so calling it again here would clobber its UI config.
...
-- jedrzejboczar/nvim-dap-cortex-debug is installed (see custom/pack.lua) but
-- not configured:
